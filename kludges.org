...
Still hoping/expecting these will be merged:
...
:END:
#+name: no-mainlib
#+begin_src emacs-lisp :post addheader(*this*,'("Package" "Class" "M" "Library"))
...
#+end_src
#+results: no-mainlib
| Package (3)           | Class  | M | Library                         |
|-----------------------+--------+---+---------------------------------|
| majapahit-theme       | gitlab | ✓ | majapahit-dark-theme.el         |
| omtose-phellack-theme | github | ✓ | variants/omtose-darker-theme.el |
| spacemacs-theme       | github | ✓ | spacemacs-common.el             |
