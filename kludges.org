...
| claude-code-ide | github | flycheck             | fake provide in test  |
...
| claude-code-ide | github | vterm                | fake provide in test  |
| claude-code-ide | github | websocket            | fake provide in test  |

- 2025-12-20 claude-code-ide https://github.com/manzaltu/claude-code-ide.el/pull/144
