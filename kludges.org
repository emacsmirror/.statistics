...
| riece           | git      | ptexinfmt        | todo                   |
| slime           | github   | cl-indent        | todo                   |
| taskpaper-mode  | github   | adaptive-wrap    | pending [[https://github.com/saf-dmitry/taskpaper-mode/issues/6][#6]]             |
...
| w3m             | orphaned | ptexinfmt        | todo                   |
| w3m             | orphaned | rfc2368          | todo                   |
...
| jabber                          | git         | password                 | should be password-cache, I believe                 |
