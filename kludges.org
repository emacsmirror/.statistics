...
#+begin_src emacs-lisp :post addheader(*this*,'(3 "Package" "Reason" "Suspended" "M" "Url"))
...
| Package (18)        | Reason           | Suspended      | M | Url                                          |
|---------------------+------------------+----------------+---+----------------------------------------------|
...
#+end_src
#+results: no-mainlib
| Package (16)          | Class    | M | Library                         | Reason                     |
|-----------------------+----------+---+---------------------------------+----------------------------|
| flymake-collection    | github   | ✓ | src/flymake-collection.el       |                            |
| dired-hacks           | github   |   | dired-hacks-utils.el            | no primary entry point [[https://github.com/Fuco1/dired-hacks/issues/31][#31]] |
...
| ddskk                 | github   | ✓ | skk.el                          | pkg/lib name mismatch [[https://github.com/skk-dev/ddskk/pull/209][#209]] |
...
| cg                 | main                       | subtree  | [[https://visl.sdu.dk/constraint_grammar.html]] |
