...
#+END_SRC
#+RESULTS: filtered
| Package (25)        | Reason           | M | Url                                          |
|---------------------+------------------+---+----------------------------------------------|
| rfringe             | all-in-one repo  |   | git@github.com:DinoChiesa/dpchiesa-elisp.git |
| tfs                 | all-in-one repo  |   | git@github.com:DinoChiesa/dpchiesa-elisp.git |
| thesaurus           | all-in-one repo  |   | git@github.com:DinoChiesa/dpchiesa-elisp.git |
| org-pua             | all-in-one repo  |   | git@github.com:Henry/dot-emacs.git           |
| thingatpt-ext       | all-in-one repo  |   | git@github.com:Henry/dot-emacs.git           |
| wn-org              | all-in-one repo  |   | git@github.com:Henry/dot-emacs.git           |
| pylint              | mostly non-elisp | ✓ | git@github.com:PyCQA/pylint.git              |
| tenv                | unclean repo     |   | git@github.com:aki2o/elisp-test.git          |
