...
| emacspeak         | github   | auth-source-pass | pending [[https://github.com/tvraman/emacspeak/pull/15][#15]]            |
...
| w3m               | orphaned | ptexinfmt        | fixme                  |
| w3m               | orphaned | rfc2368          | fixme                  |
...
| lispy                           | github      | cider-interaction        | backward compatibility                              |
...
#+END_SRC
#+RESULTS: no-mainlib
| Package (23)          | Class    | Library                         | Reason                     |
|-----------------------+----------+---------------------------------+----------------------------|
...
| eval-sexp-in-comments | github   | eval-sexp-in-comments.el        |                            |
...
| proof-general         | github   | pg-init.el                      | pending [[https://github.com/ProofGeneral/PG/issues/198][#198]]               |
