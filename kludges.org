...
| srht             | sourcehut | test                 | test file vs. package [[https://lists.sr.ht/~akagi/srht.el/%3C87iljmckpl.fsf%40bernoul.li%3E][*]] |
...
| Package (11)        | Reason           | Suspended      | M | Url                                          |
|---------------------+------------------+----------------+---+----------------------------------------------|
| cfengine-code-style | mostly non-elisp | slow           | ✓ | git@github.com:cfengine/core.git             |
| clang-format        | mostly non-elisp | extremely slow | ✓ | git@github.com:llvm/llvm-project.git         |
...
- cfengine-code-style: https://github.com/cfengine/core/discussions/5101
