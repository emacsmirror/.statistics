...
| Package (46)     | Type     | Feature               | Reason                         |
|------------------+----------+-----------------------+--------------------------------|
...
| ddskk            | github   | install               | later                          |
| ddskk            | github   | ptexinfmt             | later                          |
| ddskk            | github   | vip                   | later                          |
...
| jump             | github   | elunit                | pending [[https://github.com/eschulte/jump.el/pull/12][#12]]                    |
...
| riece            | git      | luna                  | later                          |
| riece            | git      | lunit                 | later                          |
| rinari           | github   | elunit                | pending [[https://github.com/eschulte/rinari/pull/92][#92]]                    |
...
| vm               | orphaned | vcard                 | later                          |
| wanderlust       | orphaned | bbdb-wl               | backward compatibility [[https://github.com/wanderlust/wanderlust/issues/139][#139]]    |
| wanderlust       | orphaned | ptexinfmt             | later                          |
| wanderlust       | orphaned | rfc2368               | later                          |
| wanderlust       | orphaned | ssl                   | later                          |
| wanderlust       | orphaned | utf7                  | later                          |
