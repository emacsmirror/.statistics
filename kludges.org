...
| Package (34)     | Type     | Feature               | Reason                         |
|------------------+----------+-----------------------+--------------------------------|
| amd-mode         | github   | test-helper           | pending [[https://github.com/NicolasPetton/amd-mode.el/pull/11][#11]]                    |
| anything-project | github   | anything              | staled [[https://github.com/imakado/anything-project/pull/3][#3]]                      |
| anything-project | github   | anything-match-plugin | staled [[https://github.com/imakado/anything-project/pull/3][#3]]                      |
...
| karma            | github   | test-helper           | fixme [[https://github.com/tonini/karma.el/pull/7][#7]]                       |
| lookup           | github   | stem-english          | staled [[https://github.com/lookup2/lookup2/pull/14][#14]]                     |
| m-buffer         | github   | assess-discover       | pending [[https://github.com/phillord/m-buffer-el/pull/6][#6]]                     |
| markup           | github   | ert                   | staled [[https://github.com/leoc/markup.el/pull/2][#2]]                      |
| mic-paren        | file     | paren                 | considered drop-in replacement |
| mkhtml           | wiki     | htmlize               | considered drop-in replacement |
| nav              | github   | ack                   | staled [[https://github.com/ijt/emacs-nav/pull/103][#103]]                    |
...
| pony-mode        | github   | ert                   | fixme [[https://github.com/davidmiller/pony-mode/pull/99][#99]]                      |
| projmake-mode    | github   | elisp-lint            | staled [[https://github.com/ericbmerritt/projmake-mode/pull/15][#15]]                     |
