...
| srht             | sourcehut | test                 | test file vs. package |
...
#+end_src
#+results: no-mainlib
| Package (13)          | Class    | M | Library                         | Reason                     |
|-----------------------+----------+---+---------------------------------+----------------------------|
...
- emacs-speaks-nonmem: Once [[https://github.com/mattfidler/Emacs-Speaks-NONMEM/pull/30][#30]] is merged, also rename to ~esn~.
- emux: https://github.com/re5et/emux/pull/4
- ne2wm: https://github.com/tkf/ne2wm/pull/3
- *-theme: https://github.com/melpa/melpa/issues/8219
