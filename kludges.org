...
| Package (24)    | Class    | Feature       | Reason                       |
|-----------------+----------+---------------+------------------------------|
...
| tuareg          | github   | caml          | pending [[https://github.com/ocaml/tuareg/pull/138][138]]                  |
...
| wanderlust      | orphaned | ptexinfmt     | wontfix                      |
| wanderlust      | orphaned | rfc2368       | wontfix                      |
| wanderlust      | orphaned | ssl           | wontfix                      |
| wanderlust      | orphaned | utf7          | wontfix                      |
...
| Package (64)                    | Class       | Feature                | Reason                                              |
|---------------------------------+-------------+------------------------+-----------------------------------------------------|
