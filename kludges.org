...
| Package (35)        | Class    | Feature               | Reason                         |
|---------------------+----------+-----------------------+--------------------------------|
...
| chinese-fonts-setup | github   | cfs                   | pending [[https://github.com/tumashu/chinese-fonts-setup/issues/70][#70]]                    |
| commander           | github   | ert                   | pending [[https://github.com/rejeep/commander.el/pull/10][#10]]                    |
| confluence          | orphaned | xml-rpc               | later                          |
...
| dsvn                | orphaned | psvn                  | later                          |
| dsvn                | orphaned | vc-svn                | later                          |
...
| ruby-additional     | orphaned | inf-ruby              | later                          |
| ruby-additional     | orphaned | ruby-electric         | later                          |
| ruby-additional     | orphaned | ruby-mode             | later                          |
...
| Package (65)                    | Class       | Feature                | Reason                                              |
|---------------------------------+-------------+------------------------+-----------------------------------------------------|
