...
| karma                  | github    |
| lookup                 | github    |
| majapahit-theme        | gitlab    |
| monorepo-zenitani      | github    |
| nav                    | github    |
| ne2wm                  | github    |
| oauth                  | github    |
| omtose-phellack-theme  | github    |
...
- majapahit-theme: https://gitlab.com/franksn/majapahit-theme/-/merge_requests/2
...
#+end_src
#+results: no-mainlib
| Package (1)     | Class  | M | Library             |
|-----------------+--------+---+---------------------|
| spacemacs-theme | github | ✓ | spacemacs-common.el |

- spacemacs-theme: https://github.com/nashamri/spacemacs-theme/pull/63, [[https://github.com/melpa/melpa/issues/8219][melpa#8219]]
