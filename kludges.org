...
| evil-textobj-line | github | evil-tests | badly named tests [[https://github.com/syohex/evil-textobj-line/issues/1][#1]]   |
...
| org-linkany                     | github      | anything                 | anything                                            |
| org-linkany                     | github      | anything-config          | anything                                            |
| org-linkany                     | github      | anything-hatena-bookmark | anything                                            |
| org-linkany                     | github      | anything-migemo          | anything                                            |
...
| veri-kompass                    | gitlab      | loaddefs                 | generated external file                             |
...
| modus-themes          | gitlab   | modus-vivendi-theme.el          | two-variant theme          |
