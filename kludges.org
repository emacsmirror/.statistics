...
| Package (34)     | Class    | Feature               | Reason                         |
|------------------+----------+-----------------------+--------------------------------|
...
| ddskk            | github   | dash                  | later                          |
| ddskk            | github   | htmlize               | later                          |
...
| js2-refactor     | github   | test-helper           | pending [[https://github.com/magnars/js2-refactor.el/pull/94][#94]]                    |
...
| minitest         | github   | test-helper           | pending [[https://github.com/arthurnn/minitest-emacs/pull/38][#38]]                    |
...
| Package (66)                    | Class       | Feature                | Reason                                              |
|---------------------------------+-------------+------------------------+-----------------------------------------------------|
...
| ob-coffeescript                 | github      | inf-template           | pending [[https://github.com/brantou/ob-coffeescript/issues/1][#1]]                                          |
