...
#+begin_src emacs-lisp :post addheader(*this*,'("Package" "Modified" "M" "Url"))
...
| Package (9)    |   Modified | M | Url                                          |
|----------------+------------+---+----------------------------------------------|
| clang-format   | 2019-11-06 | ✓ | git@github.com:llvm/llvm-project.git         |
| cmake-mode     | 2022-08-22 | ✓ | https://gitlab.kitware.com/cmake/cmake.git   |
| cython-mode    | 2019-01-11 | ✓ | git@github.com:cython/cython.git             |
| diffscuss-mode | 2014-10-14 | ✓ | git@github.com:tomheon/diffscuss.git         |
| google-c-style | 2022-02-10 | ✓ | git@github.com:google/styleguide.git         |
| nemerle        | 2016-10-28 | ✓ | git@github.com:rsdn/nemerle.git              |
| ninja-mode     | 2018-09-06 | ✓ | git@github.com:ninja-build/ninja.git         |
| po-mode        | 2020-06-06 | ✓ | https://git.savannah.gnu.org/git/gettext.git |
| thrift         | 2014-03-12 | ✓ | git@github.com:apache/thrift.git             |
...
| Package (21)   |   Modified | M | Url                                              |
|----------------+------------+---+--------------------------------------------------|
| agda2-mode     | 2022-11-07 |   | https://github.com/agda/agda                     |
...
| fuel           | 2022-11-08 | ✓ | git@github.com:factor/factor.git                 |
...
| lambdapi-mode  | 2022-09-09 | ✓ | git@github.com:Deducteam/lambdapi.git            |
| lfe-mode       | 2021-06-03 | ✓ | git@github.com:rvirding/lfe.git                  |
| mandoku        | 2018-04-03 | ✓ | git@github.com:mandoku/mandoku.git               |
| merlin         | 2022-06-29 | ✓ | git@github.com:the-lambda-church/merlin.git      |
| mozart         | 2017-11-11 |   | git@github.com:mozart/mozart2.git                |
| mozc           | 2022-07-07 | ✓ | git@github.com:google/mozc.git                   |
| password-store | 2022-09-06 | ✓ | https://git.zx2c4.com/password-store             |
...
| utop           | 2022-11-03 | ✓ | git@github.com:diml/utop.git                     |
...
#+end_src
#+results: no-mainlib
| Package (10)          | Class  | M | Library                         | Reason                     |
|-----------------------+--------+---+---------------------------------+----------------------------|
...
- *-theme:
  ...
  - eziam-theme: https://github.com/thblt/eziam-theme-emacs/pull/25
  - omtose-phellack-theme: https://github.com/franksn/omtose-phellack-theme/pull/5
  - spacemacs-theme: https://github.com/nashamri/spacemacs-theme/pull/63
  - punpun-theme: https://github.com/melpa/melpa/issues/8219#issuecomment-1321248457
  - majapahit-theme: https://github.com/melpa/melpa/issues/8219#issuecomment-1321248457
