...
| codex                | github   | ert                            | pending [[https://github.com/sigma/codex/pull/1][#1]] (ert)                |
...
| elim                 | shelved  | notify                         | conflicting with mirrored       |
...
| go                   | github   | gnugo                          | rejected [[https://github.com/eschulte/el-go/pull/3][#3]]                     |
...
| ilisp                | shelved  | bridge                         | also bundled with mirrored      |
...
| markup               | github   | ert                            | pending [[https://github.com/leoc/markup.el/pull/2][#2]] (ert)                |
| mic-paren            | file     | paren                          | considered drop-in replacement  |
| mkhtml               | wiki     | htmlize                        | considered drop-in replacement  |
| mupacs               | shelved  | lazy-lock                      | XEmacs compatibility            |
| nav                  | github   | ack                            | pending [[https://github.com/ijt/emacs-nav/pull/103][#103]]                    |
| nxhtml               | orphaned | html-toc                       | TODO conflicting implementation |
...
| palette              | wiki     | eyedropper                     | considered drop-in replacement  |
...
| pony-mode            | github   | ert                            | pending [[https://github.com/davidmiller/pony-mode/pull/99][#99]] (ert)               |
...
| simple-server        | shelved  | httpd                          | conflicting with mirrored       |
...
| tuareg               | github   | caml                           | considered drop-in replacement  |
...
| wrap-region          | github   | ert                            | pending [[https://github.com/rejeep/wrap-region.el/pull/31][#31]]                     |
