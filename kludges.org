...
| Package (15) | Class     | Feature        | Reason                                    |
|--------------+-----------+----------------+-------------------------------------------|
...
| Package (2) | Class  | Feature  | Reason                |
|-------------+--------+----------+-----------------------|
| company     | github | bbdb-com | provided by test file |
| org-ref     | github | org-test | provided by test file |

I currently don't have the energy to ask for conflicts to be resolved
that only affect tests.
...
| lispy                           | github   | clojure-semantic         | testing only                                        |
...
| wanderlust                      | github   | x-face-mule              | XEmacs compatibility                                |
| wanderlust                      | github   | x-face-xmas              | XEmacs compatibility                                |
