...
|---------------------+--------+----------------+----------------|
| bookmark-extensions | github | helm-delicious | helm-delicious |
| bts                 | github | pophint-config |                |
| eldev               | github | dummy-lint     |                |
| pophint             | github | e2wm-perspb    |                |

- bookmark-extensions: https://github.com/thierryvolpiatto/emacs-bmk-ext/pull/2
...
#+END_SRC
#+RESULTS: bitbucket
| Package (7)   | Bitbucket User | Repository                                    | Emacsmirror                                  |
|---------------+----------------+-----------------------------------------------+----------------------------------------------|
