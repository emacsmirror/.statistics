...
#+END_SRC
#+RESULTS: bitbucket
| Package (36)         | Bitbucket User  | Repository                                               | Emacsmirror                                         |
|----------------------+-----------------+----------------------------------------------------------+-----------------------------------------------------|
...
| instapaper           | jfm             | https://bitbucket.org/jfm/emacs-instapaper               | https://github.com/emacsmirror/instapaper           |
...
| project-root         | piranha         | https://bitbucket.org/piranha/project-root               | https://github.com/emacsmirror/project-root         |
| mmm-mako             | pjenvey         | https://bitbucket.org/pjenvey/mmm-mako                   | https://github.com/emacsmirror/mmm-mako             |
| toxi-theme           | postspectacular | https://bitbucket.org/postspectacular/toxi-theme         | https://github.com/emacsmirror/toxi-theme           |
| erc-hipchatify       | seanfarley      | https://bitbucket.org/seanfarley/erc-hipchatify          | https://github.com/emacsmirror/erc-hipchatify       |
| grass-mode           | tws             | https://bitbucket.org/tws/grass-mode.el                  | https://github.com/emacsmirror/grass-mode           |
