...
|--------------+--------------------+---------|
| matrix-theme | color-theme-modern |         |
| matrix-theme | matrix-theme       |         |

- matrix-theme: https://github.com/melpa/melpa/pull/7832
...
|----------------+--------+--------------+----------|
| clj-decompiler | github | cider-compat |          |

- clj-decompiler: https://github.com/bsless/clj-decompiler.el/issues/1
