...
- 2025-12-20 libinput https://github.com/larsmagne/bookiez.el/issues/5
- 2025-12-20 ob-csharp is part of org now but hasn't made it into release yet
...
#+end_src
#+results: unsatisfied
| Package (20)             | Class     | Feature                 | Shelved Provider   |
|--------------------------+-----------+-------------------------+--------------------|
