...
#+BEGIN_SRC emacs-lisp
  (epkg-with-org-header (1 "Package" "Library")
...
#+END_SRC
#+RESULTS: archived
| Package (5)   | Repository                 | Melpa | Reverse Dependencies |
|---------------+----------------------------+-------+----------------------|
...
| parinfer      | [[https://github.com/DogLooksGood/parinfer-mode][DogLooksGood/parinfer-mode]] | ✓     |                      |
| snippet       | [[https://github.com/pkazmier/snippet.el][pkazmier/snippet.el]]        | ✓     | rails                |

- flymake-phpcs: https://github.com/arnested/drupal-mode/issues/83
