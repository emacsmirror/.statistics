...
- *Permanent (generated version file)*
  - notmuch
...
- *Pending*
  ...
  - git-command [[https://github.com/10sr/git-command-el/pull/12][#12]]
  - haskell-mode [[https://github.com/haskell/haskell-mode/pull/1478][#1478]]
  ...
  - smart-newline [[https://github.com/ainame/smart-newline.el/pull/20][#20]]
- *Permanent*
...
| git                  | github   | ert                            |
| git-command          | github   | git-ps1-mode                   |
| git-command          | github   | term-run                       |
| git-command          | github   | with-editor                    |
| gitlab               | github   | test-helper                    |
| go                   | github   | gnugo                          |
| go-eldoc             | github   | test-helper                    |
| google-this          | github   | noflet                         |
| gotest               | github   | test-helper                    |
| haskell-mode         | github   | dash                           |
| haskell-mode         | github   | ert                            |
| haskell-mode         | github   | shut-up                        |
| haskell-mode         | github   | undercover                     |
...
| smart-newline        | github   | cursor-test                    |
| smart-newline        | github   | test-helper                    |
...
- *Permanent*
  ...
  - hyperbole: I have emailed the author.  efs is an xemacs package,
    on emacs tramp is used.  Author sais id-menubars and x-mouse are
    not hard dependencies and that he will eventually make them
    available again.  I expect "eventually" to take a long time.
  ...
  - w3: x-font-menu, xbm-button, xpm-button for XEmacs; dtk-voices is
    no longer available and not needed
  - wanderlust [[https://github.com/wanderlust/wanderlust/issues/139][#139]] bbdb-wl.el is for compatibility with older bbdb
    versions.  It's the only file that requires bbdb.  bbdb v3 comes
    with wanderlust support.
...
- *Revisit*
  ...
  - ultratex
- *Pending:* Misc
  - zotxt [[https://gitlab.com/egh/zotxt-emacs/merge_requests/2][#2]]
- *Pending:* Gelpa
...
| cask-package-toolset | github   | github | ${package-name}   |
...
- *Pending*
  ...
  - es-lib [[https://github.com/sabof/es-lib/issues/3][sabof/es-lib#3]]
  - project-explorer [[https://github.com/sabof/es-lib/issues/3][sabof/es-lib#3]]
