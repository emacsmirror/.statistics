...
- *Revisit*
  ...
  - nxhtml
  - php+-mode
  - ten-hundred-mode [[https://github.com/aaron-em/ten-hundred-mode.el/pull/3][#3]]
  - tuareg
...
| emacspeak        | github   | dom                   |
| emacspeak        | github   | nm                    |
| emacspeak        | github   | subr-x                |
...
| ten-hundred-mode | github   | levenshtein           |
| tuareg           | github   | caml                  |
...
- *Pending*
  ...
  - ecb: https://github.com/alexott/ecb/pull/36
...
| ecb             | github   | github | semantic-analyze       |
| ecb             | github   | github | semantic-ctxt          |
| general-close   | github   | github | thingatpt-highlight    |
...
- *Pending*
  ...
  - hyperbole: mailed author, sais not hard dependencies
...
- *Revisit*
- *Pending*
  - elisp-depend [[https://github.com/tehom/elisp-depend/pull/1][tehom/elisp-depend#1]]
...
| Package                   | Type        | Melpa  | Feature                  |
|---------------------------+-------------+--------+--------------------------|
| ac-haskell-process        | github      | github | haskell                  |
| auctex                    | elpa-branch |        | etexshow                 |
| clj-refactor              | github      | github | inflections              |
| company-ghci              | github      | github | haskell                  |
| drupal-mode               | github      | github | gtags                    |
| efire                     | github      | github | lui                      |
| elisp-depend              | github      | github | emtest/main/define       |
| elisp-depend              | github      | github | emtest/testhelp/standard |
| elisp-depend              | github      | github | emtest/testhelp/tagnames |
| emms-player-mpv-jp-radios | github      | github | later-do                 |
| emms-player-simple-mpv    | github      | github | later-do                 |
| ess                       | github      | github | rtf-support              |
| helm-rails                | github      | github | inflections              |
| hyperbole                 | git         |        | efs                      |
| jabber                    | git         | git    | osd                      |
| lilypond                  | git         |        | ecasound                 |
| lilypond                  | git         |        | ilisp                    |
| mpg123                    | file        | github | smart-dnd                |
| notes-mode                | elpa        |        | mailcrypt                |
| projectile-rails          | github      | github | inflections              |
| python-mode               | gitlab      | gitlab | pymacs                   |
| railgun                   | github      | github | inflections              |
| riece                     | git         |        | lsdb                     |
| rpm-spec-mode             | github      | github | shindent                 |
| ruby-factory              | github      | github | inflections              |
| slack                     | github      | github | lui                      |
| w3m                       | orphaned    | cvs    | lsdb                     |
...
| anything  | git    | git    | gtags           |
| cake      | github | github | tail            |
| cake2     | github | github | tail            |
