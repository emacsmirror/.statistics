...
|-------------+----------+---------|
| op-template | darkman  |         |
| op-template | org-page |         |

- darkman: https://github.com/grtcdr/darkman.el/pull/12
...
| org-roam               | github   | emacsql-sqlite3             | emacsql-sqlite3 |
| serverspec             | github   | helm-config                 |                 |
| tree-sitter-indent     | codeberg | csharp-tree-sitter          |                 |
| wisitoken-grammar-mode | gnu-elpa | wisitoken_grammar_1-process |                 |
