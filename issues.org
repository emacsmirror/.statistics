...
| package-build-badges | cask          |         |
| package-build-badges | package-build |         |
| package-recipe       | cask          |         |
| package-recipe       | package-build |         |
| package-recipe-mode  | cask          |         |
| package-recipe-mode  | package-build |         |

- cask: https://github.com/cask/cask/issues/580
...
|-------------+----------+---------------+----------|
| ada-mode    | gnu-elpa | gnat-compiler |          |

- ada-mode: contacted by email
