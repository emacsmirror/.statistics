...
| test-helper       | docopt             |         |
| test-helper       | parinfer-rust-mode |         |
...
- test-helper (see [[https://github.com/rejeep/ert-runner.el/issues/38][ert-runner#38]])
  - https://github.com/r0man/docopt.el/issues/21
  - https://github.com/justinbarclay/parinfer-rust-mode/issues/29
...
#+END_SRC
#+RESULTS: archived
| Package (10)     | Repository                  | Melpa | Reverse Dependencies    |
|------------------+-----------------------------+-------+-------------------------|
