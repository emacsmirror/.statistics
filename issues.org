...
There are always a few conflicts caused by AI-coded AI tools.  I am
not reporting these issues upstream because the AI is producing (and
sometimes also fixing) these issues quicker than I can report them.
...
#+end_src
#+results: unsatisfied
| Package (40)             | Class     | Feature                 | Shelved Provider   |
|--------------------------+-----------+-------------------------+--------------------|
...
| emidje                   | github    | magit-popup             | magit-popup        |
...
| jabber                   | codeberg  | jabber-omemo-core       |                    |
...
| org-seek                 | git       | ag                      | ag                 |
| org-supertag             | github    | supertag-drawer-adapter |                    |
...
| verilog-ext              | github    | ag                      | ag                 |
| verilog-ext              | github    | ripgrep                 | ripgrep            |
| vhdl-ext                 | github    | ag                      | ag                 |
| vhdl-ext                 | github    | ripgrep                 | ripgrep            |
