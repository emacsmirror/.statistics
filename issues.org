...
| light           | emacspeak            |         |
| light           | ultratex             |         |
| my-byte-compile | counsel-etags        |         |
| my-byte-compile | eacl                 |         |
| my-byte-compile | elpa-mirror          |         |
| my-byte-compile | evil-matchit         |         |
| my-byte-compile | evil-nerd-commenter  |         |
| my-byte-compile | find-file-in-project |         |
| my-byte-compile | mybigword            |         |
| my-byte-compile | shellcop             |         |
| my-byte-compile | shenshou             |         |
| my-byte-compile | vc-msg               |         |
| my-byte-compile | wucuo                |         |
| my-elint        | evil-matchit         |         |
| my-elint        | evil-nerd-commenter  |         |
| org-contacts    | org-contacts         |         |
| org-contacts    | org-contrib          |         |
...
| org-roam            | github | emacsql-libsqlite3             |          |
| python-mode         | gitlab | setup-ert-tests                |          |
| run-command-recipes | github | run-command-recipes-hashtables |          |
| sage-shell-mode     | github | tex-buf                        |          |
| ultratex            | github | tex-buf                        |          |
| xenops              | github | tex-buf                        |          |

- tex-buf: In auctex tex-buf was merged into tex
- org-roam: https://github.com/org-roam/org-roam/issues/2146
...
#+end_src
#+results: archived
| Package (1)       | Repository                      | M | Reverse Dependencies |
|-------------------+---------------------------------+---+----------------------|
| flymake-proselint | [[https://github.com/manuel-uberti/flymake-proselint][manuel-uberti/flymake-proselint]] |   |                      |

- manuel-uberti: is in the process of moving all his packages, I believe
