...
|-------------------+------------------+---------|
| bootstrap         | mini-modeline    |         |
| bootstrap         | orgstrap         |         |
| highlight         | highlight        |         |
| highlight         | lambdapi-mode    |         |
| init              | orgstrap         |         |
| init              | relative-buffers | t       |
| org-insert-dblock | orgtbl-aggregate |         |
| org-insert-dblock | orgtbl-join      |         |

- bootstrap, init:
  https://github.com/kiennq/emacs-mini-modeline/issues/41
  https://github.com/tgbugs/orgstrap/issues/1
- highlight: https://github.com/Deducteam/lambdapi/issues/435
