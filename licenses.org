...
| summarye        | failure | shelved  | https://github.com/emacsmirror/emacswiki.org      |
...
|-------------+---------+--------+------------------------------------------------|
| buckwalter  | GPL-2   | github | https://github.com/joehakimrahme/buckwalter.el |
...
#+END_SRC
#+RESULTS:
| Package (16)          | License    | Class    | M | Link                                                                           |
|-----------------------+------------+----------+---+--------------------------------------------------------------------------------|
...
| ghc                   | failure(p) | github   | t | https://github.com/DanielG/ghc-mod                                             |
| glsl-mode             | failure(p) | github   | t | https://github.com/jimhourihan/glsl-mode                                       |
| golint                | failure(p) | subtree  | t |                                                                                |
| main-line             | failure(p) | github   | t | https://github.com/emacsfodder/emacs-mainline                                  |
...
- Responses
  ...
  - gherkin-mode [[https://github.com/candera/gherkin-mode/issues/2][#2]] (incomplete)
- Huge effort
  - clang-format: BSD-3-clause
  - ruby-additional: ruby
...
#+END_SRC
#+RESULTS:
| Package (6)    | License | Class  | M | Link                                           |
|----------------+---------+--------+---+------------------------------------------------|
| buckwalter     | GPL-2   | github | t | https://github.com/joehakimrahme/buckwalter.el |
...
Pending:
- buckwalter [[https://github.com/melpa/melpa/pull/5144][melpa#5144]]
...
- stgit [[https://github.com/ctmarinas/stgit/issues/7][#7]]
