...
#+BEGIN_SRC emacs-lisp
  (emir--insert-mirror-packages-using-licenses
    "GPL" "GPL-2" "failure" "pending" "No-license" nil)
#+END_SRC
#+RESULTS:

- https://github.com/zhanxw/wdl-mode/pull/2
...
| speedread   | custom  |                                            |
| whine       | custom  |                                            |
| xrefresh    | custom  | https://github.com/justmoon/xrefresh-emacs |
| youwill     | custom  |                                            |

** Upstream contacted
#+BEGIN_SRC emacs-lisp
  (emir--insert-attic-packages-using-licenses "pending")
#+END_SRC
#+RESULTS:
| Package (38)         | License | Link                                              |
|----------------------+---------+---------------------------------------------------|
| auto-scratch         | pending | https://github.com/lovekonakona/auto-scratch      |
| bavard               | pending |                                                   |
| crab                 | pending | https://github.com/puffnfresh/crab-emacs          |
| drela-mode           | pending | https://github.com/cloudchamber/Drela-mode        |
| ess-R-object-popup   | pending | https://github.com/myuhe/ess-R-object-popup.el    |
| find-file-suggest    | pending | https://github.com/cjauvin/find-file-suggest      |
| flymake-pylint       | pending | https://github.com/btoconnor/flymake-pylint       |
| gershwin-mode        | pending | https://github.com/gershwin/emacs-gershwin-mode   |
| gitch                | pending | https://github.com/rjprins/gitch                  |
| globalizer           | pending |                                                   |
| goto-pattern         | pending | https://github.com/cjauvin/goto-pattern           |
| hippie-expand-distel | pending | https://github.com/rost/hippie-expand-distel      |
| ietfdoc              | pending |                                                   |
| imgix                | pending | https://github.com/imgix/imgix-emacs              |
| inf-js               | pending | https://github.com/bkyle/inf-js                   |
| inf-php              | pending | https://github.com/taksatou/inf-php               |
| inform7-mode         | pending | https://github.com/fred-o/inform7-mode            |
| jaunte               | pending | https://github.com/kawaguchi/jaunte.el            |
| maven-mode           | pending | https://github.com/bkyle/maven-mode               |
| memento              | pending | https://github.com/ehartc/memento                 |
| mousymacro           | pending |                                                   |
| n3-mode              | pending | https://github.com/doriantaylor/n3-mode-for-emacs |
| namazu               | pending |                                                   |
| objc-c-mode          | pending |                                                   |
| org-jekyll           | pending | https://github.com/juanre/org-jekyll              |
| partially            | pending | https://github.com/mbriggs/partially.el           |
| pyim-greatdict       | pending | https://github.com/tumashu/pyim-greatdict         |
| railgun              | pending | https://github.com/mbriggs/railgun.el             |
| rails-new            | pending | https://github.com/cheunghy/rails-new             |
| refheap              | pending | https://github.com/Raynes/refheap.el              |
| reflected-buffers    | pending | https://github.com/tkf/reflected-buffers          |
| ruby-dev             | pending | https://github.com/Mon-Ouie/ruby-dev.el           |
| ruby-guard           | pending | https://github.com/cheunghy/ruby-guard            |
| shbuf                | pending |                                                   |
| sourcetalk           | pending | https://github.com/malroc/sourcetalk_emacs        |
| testkick             | pending | https://github.com/hadashiA/testkick              |
| uzumaki              | pending | https://github.com/geyslan/uzumaki                |
| window-grid          | pending |                                                   |
...
| conjecture-mode     | GPL     |                                                |
| copyedit            | GPL-2   |                                                |
| crontab-mode        | GPL-2   | https://github.com/emacsorphanage/crontab-mode |
| cruisecontrol       | GPL-2   |                                                |
| dbk                 | GPL     |                                                |
| devkitemacs         | GPL-2   |                                                |
| dired-a             | GPL     |                                                |
