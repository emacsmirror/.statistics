...
* Pending packages (~emir-pending-packages~)
...
* Secondary packages (~emir-secondary-packages~)
...
* Suspended packages (~emir-suspended-packages~)
...
* Renamed files (~emir-renamed-files~)
...
* Preferred upstreams (~emir--preferred-updatream~)
...
* Preferred builtins (~emir--preferred-builtins~)
...
* Diverging reason (~emir--diverging-reason~)
...
* Library reason (~emir--library-reason~)
...
* Orphanage reason (~emir--orphanage-reason~)
