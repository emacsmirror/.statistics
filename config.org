...
** variable ~emir-ignored-dependencies~
#+NAME: set--emir-ignored-dependencies
#+BEGIN_SRC emacs-lisp :results silent :var value=emir-ignored-dependencies
  (emir--save-variable 'emir-ignored-dependencies
                       (--map (list (intern (car it)) (cadr it)) value))
#+END_SRC
#+NAME: emir-ignored-dependencies
| Package      | Reason |
|--------------+--------|
| balloon-help | xemacs |
| bitmap       | xemacs |
