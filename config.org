...
| copilot-chat    | TEMP renamed to gh-copilot-chat                      |

* Ignored Repositories
#+NAME: store--delayed
#+BEGIN_SRC emacs-lisp :var value=table--ignored-repos
  (emir--store-table 'var-ignored-repos value)
#+END_SRC
#+NAME: table--ignored-repos
| Repository                                               | Reason         |
|----------------------------------------------------------+----------------|
| https://github.com/madara123pain/unique-emacs-theme-pack | limited appeal |
...
| keychain-environment   | dropped by maintainer   |
...
| org-elisp-help         | dropped by maintainer   |
...
| org-wild-notifier      | dropped by maintainer   |
...
| Package     | Reason                     |
|-------------+----------------------------|
| agda2-mode  | takes 17 minutes to filter |
| citar-typst | fetching hangs             |
| cmake-mode  | takes 50 minutes to filter |
| erk         | todo                       |
| kubernetes  | repository compromised     |
| yatex       | bug in hg remote-helper    |
