...
| caml             | A. semi-manual svn import   |
| cg               | A. semi-manual svn import   |
| clang-format     | A. semi-manual svn import   |
| color-theme      | 5. bzr not supported        |
| confluence       | A. semi-manual svn import   |
| crontab-mode     | 3. upstream disappeared     |
| dedicated        | 2. upstream has disappeared |
| dic-lookup-w3m   | A. semi-manual svn import   |
| dirtree          | 9. wiki needed by non-wiki  |
| doom             | 3. upstream unresponsive    |
| ecasound         | 3. upstream disappeared     |
| edb              | C. unmaintained, needed fix |
| elisp-depend     | 3. upstream unresponsive    |
| elo              | 4. dropped of by maintainer |
| ert-expectations | 9. wiki needed by non-wiki  |
| eshell-manual    | 3. upstream unresponsive    |
| filladapt        | 3. upstream unresponsive    |
| findr            | 9. wiki needed by non-wiki  |
| flim             | 6. many feature conflicts   |
| helm-ls-svn      | A. semi-manual svn import   |
| hide-lines       | 9. wiki needed by non-wiki  |
| http-post-simple | 9. wiki needed by non-wiki  |
| hyperspec        | B. multiple non-upstreams   |
| key-chord        | 9. wiki needed by non-wiki  |
| keydef           | 2. upstream disappeared     |
| levenshtein      | 9. wiki needed by non-wiki  |
| linkd            | 7. include the images       |
| lively           | 3. upstream unresponsive    |
| look-mode        | 9. wiki needed by non-wiki  |
| lsdb             | 5. tarball not supported    |
| miniedit         | 2. upstream disappeared     |
| multi-term       | 9. wiki needed by non-wiki  |
...
| ruby-additional  | A. semi-manual svn import   |
| semi             | 6. many feature conflicts   |
| session          | 5. tarball not supported    |
| setnu            | 3. upstream unresponsive    |
| shell-command    | 9. wiki needed by non-wiki  |
| shell-history    | 9. wiki needed by non-wiki  |
| showtip          | 9. wiki needed by non-wiki  |
| smarty-mode      | 2. upstream has disappeared |
| sml-modeline     | 5. bzr not supported        |
| sr-speedbar      | 9. wiki needed by non-wiki  |
| swbuff           | 5. cvs not supported        |
| tail             | 2. upstream has disappeared |
| text-translator  | 5. bzr not supported        |
| transpose-frame  | 9. wiki needed by non-wiki  |
| tree-mode        | 9. wiki needed by non-wiki  |
| vala-mode        | 2. upstream has disappeared |
| vc-fossil        | 5. fossil not supported     |
| vm               | 5. bzr not supported        |
| w32-browser      | 9. wiki needed by non-wiki  |
| w3m              | A. cvs not supported       |
| wanderlust       | 6. many feature conflicts   |
| windata          | 9. wiki needed by non-wiki  |
