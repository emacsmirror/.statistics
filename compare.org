...
| shelved     | 1106 |        |  1106 |       |       |       |
|-------------+------+--------+-------+-------+-------+-------|
| total       | 6802 |   5241 |  1106 |   457 |   184 |  3862 |
...
| rfringe              | minority | github    | all-in-one repo            |
| sequential-command   | shelved  | wiki      |                            |
| smart-compile        | minority | github    | all-in-one repo            |
| summarye             | shelved  | wiki      |                            |
| tfs                  | minority | github    | all-in-one repo            |
| thesaurus            | minority | github    | all-in-one repo            |
