...
| shelved     | 1242 |        |  1242 |       |       |       |
|-------------+------+--------+-------+-------+-------+-------|
| total       | 6979 |   5282 |  1242 |   457 |   195 |  3969 |
...
#+BEGIN_SRC emacs-lisp
  (epkg-with-org-header ("Package" "Gelpa")
    (-filter (pcase-lambda (`(,name ,class))
               (not (or (assoc name emir-pending-packages)
                        (equal name "nadvice")))) ; forward compatibility
    ...
    (-keep
     (pcase-lambda (`(,name ,class ,fetcher ,repo))
       (and (not (pcase (list class fetcher)
                   ...
                   (`(subtree  git)    t)
                   (`(orphaned github) t)
                   (`(file     github) (string-prefix-p "emacsmirror/" repo))
                   (`(shelved  github) (string-prefix-p "emacsattic/" repo))))
...
| clojure-cheatsheet    | shelved  | github    |                      |
...
| kfg                   | shelved  | github    |                      |
| less-css-mode         | builtin  | github    | Emacs 26.1 has newer |
...
- less-css-mode: https://github.com/purcell/less-css-mode/issues/26
