...
#+BEGIN_SRC emacs-lisp
  (epkg-with-org-header ("Package" "Type")
...
#+BEGIN_SRC emacs-lisp
  (epkg-with-org-header ("Package" "Reason")
    (--keep (assoc (car it) emir-pending-packages)
  ...
  (epkg-with-org-header ("Package" "Reason")
    (mapcar (-lambda ((name))
              (or (and (gelpa-builtin-recipe-p (gelpa-get name))
                       (list name "Elpa has copy of builtin"))
                  (assoc name emir--preferred-builtins)
                  (list name "")))
...
#+BEGIN_SRC emacs-lisp
  (epkg-with-org-header ("Package" "Type" "Gelpa" "Link")
...
#+NAME: melpa-new
#+BEGIN_SRC emacs-lisp
  (epkg-with-org-header ("Package" "Type" "Link")
...
#+BEGIN_SRC emacs-lisp
  (epkg-with-org-header ("Primary package" "Secondary package" "Type")
    (epkg-sql [:select :distinct [packages:name
                                  melpa-recipes:name
                                  packages:class]
...
#+BEGIN_SRC emacs-lisp
  (epkg-with-org-header ("Package" "Type" "Melpa" "Reason")
