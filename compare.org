...
| Package               | Type     | Melpa     | Reason                                  |
|-----------------------+----------+-----------+-----------------------------------------|
| autotest              | minority | github    | unrelated in one git repo [[https://github.com/zenspider/elisp/issues/5][#5]] (rejected) |
...
| ox-clip               | minority | github    | unrelated in one git repo [[https://github.com/jkitchin/scimax/issues/21][#21]] (pending) |
...
| toggle                | minority | github    | unrelated in one git repo [[https://github.com/zenspider/elisp/issues/5][#5]] (rejected) |
