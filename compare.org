...
| shelved     | 1237 |        |  1237 |       |       |       |
|-------------+------+--------+-------+-------+-------+-------|
| total       | 6963 |   5271 |  1237 |   457 |   194 |  3952 |
...
#+BEGIN_SRC emacs-lisp
  (epkg-with-org-header ("Package" "Gelpa")
    (--filter (not (assoc (car it) emir-pending-packages))
...
|------------------+--------+----------------------------------------------|
| company-solidity | github | merged into solidity-mode; TODO update Melpa |
| emms-player-mpv  | github | merged into emms, to be removed from melpa   |
...
| Primary package (84)      | Secondary package                 | Class    |
|---------------------------+-----------------------------------+----------|
...
| Package (22)          | Class    | Melpa     | Reason                     |
|-----------------------+----------+-----------+----------------------------|
| auth-source-pass      | builtin  | github    |                            |
| autotest              | minority | github    | all-in-one repo [[https://github.com/zenspider/elisp/issues/5][#5]]         |
| bibliothek            | minority | github    | all-in-one repo [[https://github.com/melpa/melpa/pull/5018][melpa#5018]] |
...
| debian-changelog-mode | shelved  | git       |                            |
| diffscuss-mode        | minority | github    | mostly non-elisp           |
| fold-dwim-org         | shelved  | github    |                            |
...
| org-variable-pitch    | minority | github    |                            |
