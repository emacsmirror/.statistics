...
|-------------+------+--------+-------+-------+----------+-------------+-------|
| builtin     |  509 |        |       |   512 |       22 |             |       |
| gnu-elpa    |  154 |    154 |       |       |      144 |             |       |
| nongnu-elpa |    0 |      0 |       |       |          |           1 |       |
|-------------+------+--------+-------+-------+----------+-------------+-------|
| github      | 5873 |   5873 |       |       |      239 |         210 |  5269 |
| codeberg    |  229 |    229 |       |       |       27 |          50 |   189 |
| gitlab      |  183 |    183 |       |       |       18 |           8 |   166 |
| sourcehut   |  127 |    127 |       |       |       23 |           6 |    80 |
| gnu         |    9 |      9 |       |       |       10 |           0 |     3 |
| nongnu      |    7 |      7 |       |       |        4 |           0 |     2 |
|-------------+------+--------+-------+-------+----------+-------------+-------|
| git         |  142 |    142 |       |       |       21 |           7 |   108 |
| hg          |   16 |     16 |       |       |        1 |           0 |    14 |
|-------------+------+--------+-------+-------+----------+-------------+-------|
| subtree     |   23 |     23 |       |       |          |             |       |
| wiki        |  165 |    165 |       |       |          |             |       |
| file        |    7 |      7 |       |       |          |             |       |
|-------------+------+--------+-------+-------+----------+-------------+-------|
| orphaned    |  139 |    139 |       |       |          |             |   110 |
| shelved     | 2176 |        |  2176 |       |          |             |    42 |
| mirror      |      |        |       |       |          |             |    12 |
|-------------+------+--------+-------+-------+----------+-------------+-------|
| secondary   |      |        |       |       |          |             |   272 |
| unreleased  |      |        |       |       |        6 |           0 |       |
|-------------+------+--------+-------+-------+----------+-------------+-------|
| total       | 9759 |   7074 |  2176 |   512 |      515 |         282 |  6267 |
...
|---------------------+----------|
| agitate             | github   |
| emacs-lisp-intro-nl | codeberg |
| prefixed-core       | internal |
| shell-quasiquote    | internal |
| sql-smie            | internal |
| systemd             | internal |

- 2022-09-28 agitate
- 2026-01-29 emacs-lisp-intro-nl
- 2020-12-14
  ee03829f90d25f62c2d36c5fef6f7b5eafb1040d
...
|-------------+--------+--------------------------------------------+----------+-------------------------------------------------|
| forgejo     | git    | https://git.thanosapollo.org/emacs-forgejo | codeberg | https://codeberg.org/thanosapollo/emacs-forgejo |
| gnosis      | git    | https://git.thanosapollo.org/emacs-gnosis  | git      | https://git.thanosapollo.org/gnosis             |
...
| parser-generator    | https://forgejo.cvj.se/cjohansson/emacs-parser-generator |
| phps-mode           | https://forgejo.cvj.se/cjohansson/emacs-phps-mode        |
| ssh-deploy          | https://forgejo.cvj.se/cjohansson/emacs-ssh-deploy       |
| buildbot            | https://g.ypei.me/buildbot.el.git                        |
| vcl-mode            | https://git.gnu.org.ua/vcl-mode.git                      |
| ffs                 | https://git.kelar.org/~bandali/ffs                       |
| emacs-lisp-intro-es | https://git.savannah.nongnu.org:/git/elisp-es.git        |
| clipboard-collector | https://github.com/clemera/clipboard-collector           |
| ebdb                | https://github.com/girzel/ebdb.git                       |
| idlwave             | https://github.com/jdtsmith/idlwave                      |
...
| Package (2)              | Mirror   |                                                        | Elpa   |                                                       |
|--------------------------+----------+--------------------------------------------------------+--------+-------------------------------------------------------|
| selected-window-contrast | codeberg | https://codeberg.org/Anoncheg/selected-window-contrast | github | https://github.com/Anoncheg1/selected-window-contrast |
...
- 2026-03-29 selected-window-contrast: Unclear which is preferred
- 2026-04-03 jabber: Stick to codeberg, its issue tracker is still being used
...
| pcmpl-homebrew              | https://github.com/suzzvv/pcmpl-homebrew                                    |
| pcmpl-pip                   | https://github.com/suzzvv/pcmpl-pip                                         |
...
| trimspace-mode              | https://github.com/bkhl/trimspace-mode                                      |
...
| Primary package (153)   | Secondary package                | Class     |
|-------------------------+----------------------------------+-----------|
...
| dylan                   | dime                             | github    |
| ekg                     | ekg-agent                        | github    |
| ekg                     | ekg-denote                       | github    |
...
| gumshoe                 | consult-gumshoe                  | github    |
| gumshoe                 | persp-gumshoe                    | github    |
...
| musicbrainz             | musicbrainz-interactive          | github    |
...
| ripgrep                 | projectile-ripgrep               | shelved   |
...
|-----------------+--------+-------------------------------------+--------+-----------------------------|
| grayscale-theme | github | [[https://github.com/belak-archive/emacs-grayscale-theme][belak-archive/emacs-grayscale-theme]] | github | [[https://github.com/belak/emacs-grayscale-theme][belak/emacs-grayscale-theme]] |
...
| magit-popup          | https://github.com/emacsattic/magit-popup          |
...
| secretaria           | https://github.com/emacsattic/secretaria           |
