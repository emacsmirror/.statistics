...
|-------------+------+--------+-------+-------+----------+-------------+-------|
| builtin     |  469 |        |       |   472 |       16 |             |       |
| gnu-elpa    |  144 |    144 |       |       |      133 |             |       |
| nongnu-elpa |    0 |      0 |       |       |          |           0 |       |
|-------------+------+--------+-------+-------+----------+-------------+-------|
| github      | 5148 |   5148 |       |       |      154 |         146 |  4581 |
| gitlab      |  177 |    177 |       |       |       18 |          13 |   157 |
| codeberg    |   76 |     76 |       |       |        1 |          29 |    64 |
| sourcehut   |   69 |     69 |       |       |       21 |           4 |    44 |
| gnu         |   10 |     10 |       |       |        8 |           0 |     1 |
| nongnu      |    8 |      8 |       |       |        3 |           0 |     3 |
|-------------+------+--------+-------+-------+----------+-------------+-------|
| git         |  106 |    106 |       |       |       16 |           4 |    92 |
...
| file        |   53 |     53 |       |       |          |             |       |
|-------------+------+--------+-------+-------+----------+-------------+-------|
| orphaned    |  140 |    140 |       |       |          |             |   106 |
| shelved     | 1482 |        |  1482 |       |          |             |    18 |
| mirror      |      |        |       |       |          |             |    10 |
|-------------+------+--------+-------+-------+----------+-------------+-------|
| secondary   |      |        |       |       |          |             |   231 |
| unreleased  |      |        |       |       |        7 |           1 |       |
|-------------+------+--------+-------+-------+----------+-------------+-------|
| total       | 8519 |   6568 |  1482 |   472 |      378 |         197 |  5321 |
...
| altcaps                    | sourcehut | sourcehut | [[https://git.sr.ht/~protesilaos/altcaps][protesilaos/altcaps]]                             |
| async                      | github    | github    | [[https://github.com/jwiegley/emacs-async][jwiegley/emacs-async]]                            |
| auctex                     | gnu       | gnu       | [[https://www.gnu.org/software/auctex][gnu:auctex]]                                      |
...
| jarchive                   | sourcehut | sourcehut | [[https://git.sr.ht/~dannyfreeman/jarchive][dannyfreeman/jarchive]]                           |
...
| kiwix                      | git       | git       | [[https://repo.or.cz/kiwix.el.git]]                 |
...
| arduino-mode          | git       | git       | [[https://repo.or.cz/arduino-mode.git]]       |
...
| blow                  | codeberg  | codeberg  | [[https://codeberg.org/akib/emacs-blow][akib/emacs-blow]]                           |
...
| camera                | codeberg  | codeberg  | [[https://codeberg.org/akib/emacs-camera][akib/emacs-camera]]                         |
...
| corfu-terminal        | codeberg  | codeberg  | [[https://codeberg.org/akib/emacs-corfu-terminal][akib/emacs-corfu-terminal]]                 |
...
| devhelp               | codeberg  | codeberg  | [[https://codeberg.org/akib/emacs-devhelp][akib/emacs-devhelp]]                        |
...
| eat                   | codeberg  | codeberg  | [[https://codeberg.org/akib/emacs-eat][akib/emacs-eat]]                            |
...
| flymake-popon         | codeberg  | codeberg  | [[https://codeberg.org/akib/emacs-flymake-popon][akib/emacs-flymake-popon]]                  |
...
| gc-buffers            | codeberg  | codeberg  | [[https://codeberg.org/akib/emacs-gc-buffers][akib/emacs-gc-buffers]]                     |
...
| gnu-indent            | codeberg  | codeberg  | [[https://codeberg.org/akib/emacs-gnu-indent][akib/emacs-gnu-indent]]                     |
...
| haskell-tng-mode      | gitlab    | gitlab    | [[https://gitlab.com/tseenshe/haskell-tng.el][tseenshe/haskell-tng.el]]                   |
...
| hl-column             | codeberg  | codeberg  | [[https://codeberg.org/akib/emacs-hl-column][akib/emacs-hl-column]]                      |
...
| iwindow               | codeberg  | codeberg  | [[https://codeberg.org/akib/emacs-iwindow][akib/emacs-iwindow]]                        |
...
| minibar               | codeberg  | codeberg  | [[https://codeberg.org/akib/emacs-minibar][akib/emacs-minibar]]                        |
...
| popon                 | codeberg  | codeberg  | [[https://codeberg.org/akib/emacs-popon][akib/emacs-popon]]                          |
...
| subed                 | github    | github    | [[https://github.com/sachac/subed][sachac/subed]]                              |
| sweeprolog            | github    | github    | [[https://github.com/SWI-Prolog/packages-sweep][SWI-Prolog/packages-sweep]]                 |
| swift-mode            | github    | github    | [[https://github.com/swift-emacs/swift-mode][swift-emacs/swift-mode]]                    |
| swsw                  | sourcehut | sourcehut | [[https://git.sr.ht/~dsemy/swsw][dsemy/swsw]]                                |
...
| testcover-mark-line   | codeberg  | codeberg  | [[https://codeberg.org/akib/emacs-testcover-mark-line][akib/emacs-testcover-mark-line]]            |
...
| vcomplete             | sourcehut | sourcehut | [[https://git.sr.ht/~dsemy/vcomplete][dsemy/vcomplete]]                           |
...
| why-this              | codeberg  | codeberg  | [[https://codeberg.org/akib/emacs-why-this][akib/emacs-why-this]]                       |
...
| workroom              | codeberg  | codeberg  | [[https://codeberg.org/akib/emacs-workroom][akib/emacs-workroom]]                       |
