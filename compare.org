...
| shelved      |  969 |        |   969 |       |       |       |
|--------------+------+--------+-------+-------+-------+-------|
| total        | 6489 |   5097 |   969 |   426 |   155 |  3587 |
...
#+BEGIN_SRC emacs-lisp
  (emir--with-org-header ("Package" "Reason")
    (--filter (assoc (car it) emir-pending-packages)
...
#+BEGIN_SRC emacs-lisp
  (emir--with-org-header ("Package" "Reason")
    (let ((externals (emir-gelpa--externals)))
      (mapcar (-lambda ((name))
                (or (and (equal (cadr (assoc name externals)) :core)
...
| Package (59)               | Type     | Gelpa     | Method   | Reason               | Link                                         |
|----------------------------+----------+-----------+----------+----------------------+----------------------------------------------|
...
| Package (1) | Reason                |
|-------------+-----------------------|
| flow-mode   | don't add; [[https://github.com/melpa/melpa/pull/4638][melpa#4638]] |
...
| Primary package (73)    | Secondary package               | Type      |
|-------------------------+---------------------------------+-----------|
