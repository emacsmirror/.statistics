...
| nongnu-elpa |    0 |      0 |       |       |          |           0 |       |
|-------------+------+--------+-------+-------+----------+-------------+-------|
| github      | 5416 |   5416 |       |       |      194 |         174 |  4844 |
| gitlab      |  190 |    190 |       |       |       17 |          13 |   171 |
...
| shelved     | 1536 |        |  1536 |       |          |             |    21 |
| mirror      |      |        |       |       |          |             |    12 |
|-------------+------+--------+-------+-------+----------+-------------+-------|
| secondary   |      |        |       |       |          |             |   261 |
| unreleased  |      |        |       |       |        6 |           0 |       |
|-------------+------+--------+-------+-------+----------+-------------+-------|
| total       | 8937 |   6910 |  1536 |   498 |      429 |         227 |  5681 |
...
| Package (1)        | Repository                | Melpa | Dependants |
|--------------------+---------------------------+-------+------------|
| use-package-el-get | [[https://github.com/edvorg/use-package-el-get][edvorg/use-package-el-get]] |  2827 |            |

- TODO Use this opportunity to implement a new shelve variant "update
  Melpa to get it from the attic" in addition to the existing "also
