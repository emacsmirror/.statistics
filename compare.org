...
| shelved     |  991 |        |   991 |       |       |       |
|-------------+------+--------+-------+-------+-------+-------|
| total       | 6592 |   5178 |   991 |   426 |   167 |  3677 |
...
#+BEGIN_SRC emacs-lisp
  (epkg-with-org-header ("Package" "Gelpa" "Reason")
    (-keep (-lambda ((name class))
             (--when-let (cadr (assoc (car it) emir-pending-packages))
               (list name class it)))
           (epkg-sql [:select [name class]
                      :from gelpa-recipes
                      :where (isnull epkg-package)
...
|-------------+--------+---------------|
| quiz        | github | [[https://github.com/davep/quiz.el][davep/quiz.el]] |
...
| cnfonts                 | chinese-fonts-setup             | github    |
...
|-------------+---------------------+-----------------------------|
| psci        | [[https://github.com/ardumont/emacs-psci][ardumont/emacs-psci]] | [[https://github.com/purescript-emacs/emacs-psci][purescript-emacs/emacs-psci]] |
...
| darcsum               | minority | darcs     | darcs [[https://github.com/emacsorphanage/darcsum/commit/e6d8b3b07fa2145210520861cf7f7062bfc6feb9][e6d8b3b]]                |
...
| metafmt               | shelved  | github    | upstream gone [[https://github.com/melpa/melpa/issues/4622][melpa#4622]]     |
| mic-paren             | shelved  | github    |                              |
...
| redshank              | shelved  | git       | upstream gone [[https://github.com/melpa/melpa/issues/4622][melpa#4622]]     |
| ruby-additional       | orphaned | svn       | svn                          |
